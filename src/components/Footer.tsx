          ...
          <div className="md:col-span-2">
            ...
            <div className="bg-orange-500/[0.03] border border-orange-500/15 rounded-2xl p-5 space-y-4 max-w-sm">
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">Rescue Team</div>
                  <a
                ...
                <div>
                  <div className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">Customer Care / Donations</div>
                  <a
                ...
                <div>
                  <div className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">Medical / Social Media</div>
                  <a
