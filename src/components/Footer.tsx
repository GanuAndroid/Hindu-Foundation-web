    ...
    <footer className="bg-[#060B18] text-white border-t border-orange-500/10">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* WhatsApp Support (No Calls) */}
          <div>
            <h3 className="text-sm font-bold text-orange-400 tracking-wider uppercase mb-4 whitespace-normal leading-tight">
              WhatsApp Support <span className="text-[11px] text-white/50 block normal-case font-semibold tracking-normal mt-0.5">(No Calls)</span>
            </h3>
            <ul className="space-y-4 text-sm text-white/70">
              <li className="flex flex-col">
                <span className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">{t("home.rescueTeam")}</span>
                <a
                  href="https://wa.me/918447816192"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-black text-emerald-400 hover:text-emerald-300 transition-colors inline-flex items-center gap-1.5 mt-1.5 w-max"
                >
                  ...
                  <span>+91 84478 16192</span>
                </a>
              </li>
              <li className="flex flex-col">
                <span className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">{t("home.customerCare")}</span>
                <a
                ...
                >
                  ...
                  <span>+91 85120 80346</span>
                </a>
              </li>
              <li className="flex flex-col">
                <span className="text-[10px] tracking-wide text-white/50 font-bold uppercase leading-none">{t("home.medicalSocial")}</span>
                <a
