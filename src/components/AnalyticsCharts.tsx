...
import { TrendingUp, Landmark, ShieldCheck, Heart } from "lucide-react";
...
export default function AnalyticsCharts() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      {/* Animal Categories Report Breakdown */}
      <div className="bg-slate-900 border border-white/10 rounded-3xl p-6 shadow-xl lg:col-span-2">
