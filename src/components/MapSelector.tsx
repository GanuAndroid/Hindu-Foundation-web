    ...
    <div className="flex flex-col gap-3 w-full bg-white dark:bg-slate-900 border border-white/10 p-4 rounded-2xl shadow-xl">
      ...
      <div className="bg-slate-950 border border-orange-500/30 rounded-2xl p-4 flex flex-wrap gap-4 text-xs font-bold shadow-inner">
        <div className="bg-white/[0.02] border border-white/5 p-3 rounded-xl flex-1 min-w-[140px]">
          <span className="block text-xs uppercase text-orange-400 font-black tracking-wider mb-1">{tLoc.latitude}</span>
          <span className="font-mono text-white text-base font-black select-all">{lat}</span>
        </div>
        <div className="bg-white/[0.02] border border-white/5 p-3 rounded-xl flex-1 min-w-[140px]">
          <span className="block text-xs uppercase text-orange-400 font-black tracking-wider mb-1">{tLoc.longitude}</span>
          <span className="font-mono text-white text-base font-black select-all">{lng}</span>
        </div>
        <div className="bg-white/[0.02] border border-white/5 p-3 rounded-xl flex-[2_2_0%] min-w-[280px]">
          <span className="block text-xs uppercase text-orange-400 font-black tracking-wider mb-1">{tLoc.address}</span>
          <span className="text-white text-sm font-black leading-normal block break-words" title={address}>
            {address}
          </span>
        </div>
      </div>
